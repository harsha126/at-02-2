...
import { formatMessageTime } from "../lib/utis";
...
const ChatContainer = () => {
    ...
    useEffect(() => {
        const messageEndRef2 = messageEndRef.current;
        if (messageEndRef2 && messages.length > 0) {
            messageEndRef2.scrollIntoView({ behavior: "smooth" });
        }
    }, [messages]);
